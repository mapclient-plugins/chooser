...
from mapclientplugins.chooserstep.ui_configuredialog import Ui_ConfigureDialog
...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def getConfig(self):
        ...
        config = {
            ...
            'file_chooser_count': self._ui.spinBoxFileChoosers.value(),
            'directory_chooser_count': self._ui.spinBoxDirectoryChoosers.value()
        }
        return config
